...
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/declaration/CapabilityRequirement.java`
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/capability/CapabilityRegistration.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/capability/ProviderRef.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/declaration/PluginDefinitionTest.java`
...
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/capability/CapabilityRouter.java`
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/capability/CapabilityRegistry.java`
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/dependency/DependencyResolver.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/config/ConfigurationManagerTest.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/capability/CapabilityRouterTest.java`
...
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/declaration/PluginManifestParser.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/declaration/JacksonPluginManifestParser.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/capability/CapabilityTypeRegistry.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/discovery/PluginDefinitionCompiler.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/discovery/PluginDiscoveryReport.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/discovery/RejectedPluginDefinition.java`
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/status/PluginStatusCode.java`
- Modify: `innospots-nexus-plugin/pom.xml`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/discovery/PluginDefinitionCompilerTest.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/declaration/JacksonPluginManifestParserTest.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/status/PluginStatusCodeTest.java`
...
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/discovery/PluginCatalog.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/discovery/ManifestPlugin.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/discovery/ClasspathPluginDiscoveryTest.java`
...
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/contribution/PluginContributionDecoder.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/contribution/PluginContributionDecoderRegistry.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/contribution/PluginContributionHandler.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/contribution/PluginContributionSnapshotter.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/contribution/PluginContributionSnapshotterRegistry.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/contribution/PreparedPluginContribution.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/contribution/PluginContributionContext.java`
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/declaration/PluginDefinition.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/contribution/PluginContributionContractsTest.java`
...
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/runtime/DefaultPluginManager.java`
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/runtime/PluginRuntimeConfig.java`
- Modify: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/lifecycle/PluginRuntimeInfo.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/lifecycle/ManagedPluginTest.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/runtime/PluginRuntimeScenariosTest.java`
...
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/domain/entity/PluginInstallationEntity.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/domain/enums/PluginPresence.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/domain/enums/PluginSourceType.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/domain/model/PluginDefinitionSnapshot.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/domain/model/PluginDefinitionSnapshotMapper.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/domain/model/PluginInstallation.java`
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/repository/PluginInstallationRepository.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/installation/PluginInstallationRepositoryTest.java`
- Create: `innospots-nexus-plugin/docs/plugin-installation-schema.sql`
...
- Create: `innospots-nexus-plugin/src/main/java/com/innospots/nexus/core/plugin/installation/domain/model/PluginManagementView.java`
- Test: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/installation/PluginInstallationManagerTest.java`
...
- Create: `innospots-nexus-plugin/src/test/java/com/innospots/nexus/core/plugin/installation/PluginHostAssemblyTest.java`

...
public class PluginHostStartupTaskProducer {
    ...
    private final Instance<PluginContributionHandlers> contributionHandlers;
    ...
    public PluginHostStartupTaskProducer(
            ...
            Instance<PluginContributionHandlers> handlers,
    ...
    private PluginHostBootstrapRequest bootstrapRequest() {
        ...
        List<PluginContributionHandler<?>> handlers = contributionHandlers.isResolvable()
                ? contributionHandlers.get().handlers()
                : List.of();

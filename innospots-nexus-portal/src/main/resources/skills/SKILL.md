---
name: innospots-nexus-portal
description: |
  Functional portal domain contracts for Innospots Nexus management capabilities.
...
`innospots-nexus-portal` owns the functional domain contracts for management
...
portal domain needs a stable persistence shape, but it does not bind to Spring,
...
|-------|------|-------------|
| `PortalDomain` | `enum` | Stable list of portal-owned business domains. |
...
| Portal business domains | `references/business-domain.md` |

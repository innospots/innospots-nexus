package com.innospots.nexus.portal.user.domain;
...
class UserDomainPackageContractsTest {
    ...
    void userDomainDefinesExpectedSubPackages() throws ClassNotFoundException {
        assertPackageExists("com.innospots.nexus.portal.user.domain.entity");
        assertPackageExists("com.innospots.nexus.portal.user.domain.vo");
        assertPackageExists("com.innospots.nexus.portal.user.domain.request");
        assertPackageExists("com.innospots.nexus.portal.user.domain.model");
    }

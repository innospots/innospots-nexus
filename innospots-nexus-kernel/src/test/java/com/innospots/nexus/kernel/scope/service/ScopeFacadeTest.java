...
class ScopeFacadeTest {
    ...
    private static final class ScopeHarness {
        ...
        private ScopeHarness() {
            ...
            KernelTenantScopeDirectory tenantScopeDirectory = mock(KernelTenantScopeDirectory.class);
            KernelWorkspaceScopeDirectory workspaceScopeDirectory = mock(KernelWorkspaceScopeDirectory.class);
            KernelProjectScopeDirectory projectScopeDirectory = mock(KernelProjectScopeDirectory.class);
            ...
            SessionScopeBinder sessionScopeBinder = new KernelSessionScopeBinder(
        ...
        private static void stubTenantScope(KernelTenantScopeDirectory tenantScopeDirectory) {

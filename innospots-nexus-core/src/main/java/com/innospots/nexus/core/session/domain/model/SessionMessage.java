package com.innospots.nexus.core.session.domain.model;

import com.innospots.nexus.base.domain.field.DomainField;
import com.innospots.nexus.core.session.domain.enums.SessionMessageType;
...
public class SessionMessage {
    ...
    public SessionMessage createdAt(LocalDateTime createdAt) {

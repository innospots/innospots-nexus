...
@Table(name = MenuEntity.TABLE_NAME, indexes = {
        @Index(name = "uk_nx_menu_project_key", columnList = "workspace_id,menu_key", unique = true),
        @Index(name = "idx_nx_menu_project_parent_order", columnList = "workspace_id,parent_id,sort_order"),
        @Index(name = "idx_nx_menu_project_status_visible", columnList = "workspace_id,status,visible"),
        @Index(name = "idx_nx_menu_realm", columnList = "security_realm")
})
@TableName(MenuEntity.TABLE_NAME)
public class MenuEntity extends WorkspaceBaseEntity {

...
/**
 * Deserializes {@link com.innospots.nexus.base.ui.spec.node.Children} from either a YAML
 * array or a single {@link com.innospots.nexus.base.ui.spec.node.DslSourceRef} object.
 */
public final class ChildrenDeserializer extends JsonDeserializer<Children> {
    ...
    static DslRenderable readRenderable(ObjectMapper mapper, JsonNode node) throws IOException {
        ...
        if (node.has("component")) {
            return mapper.treeToValue(node, com.innospots.nexus.base.ui.spec.node.ComponentReferenceNode.class);
        }
        return mapper.treeToValue(node, com.innospots.nexus.base.ui.spec.node.ComponentNode.class);
    }
}
